...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        animateBalloon(learningNowView, radius: 3, duration: 15, clockwise: false)
        animateBalloon(learningLabelView, radius: 3, duration: 15, clockwise: false)
        
        addLabelsAroundCircle(view: streakCircleView, radius: (streakCircleView.bounds.size.width / 2) - 13, count: 10)
        animateBalloon(streakView, radius: 4, duration: 18, clockwise: true)
        animateBalloon(streakLabelView, radius: 4, duration: 18, clockwise: true)
        animateBalloon(streakCircleView, radius: 4, duration: 18, clockwise: true)
